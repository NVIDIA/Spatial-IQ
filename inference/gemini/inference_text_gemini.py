...
"""
Text-output inference script for NVIDIA Inference API (Gemini 3 Pro).
...
def main():
    parser = argparse.ArgumentParser(
        description="Run Gemini 3 Pro via NVIDIA Inference API (text output: addition if no folder, SpatialIQ if folder given)."
    )
    parser.add_argument(
        "folder",
