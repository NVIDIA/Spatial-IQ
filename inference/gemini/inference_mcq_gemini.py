...
"""
MCQ inference script for NVIDIA Inference API (Gemini 3 Pro).
...
def main():
    parser = argparse.ArgumentParser(
        description="Run Gemini 3 Pro via NVIDIA Inference API (MCQ: send reference + choice images, get A-E answer)."
    )
    parser.add_argument(
        "folder",
