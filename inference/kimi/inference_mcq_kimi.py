...
"""
MCQ inference script for NVIDIA Inference API (Kimi K2.5).
...
def main():
    parser = argparse.ArgumentParser(
        description="Run Kimi K2.5 via NVIDIA Inference API (MCQ: send reference + choice images, get A-E answer)."
    )
    parser.add_argument(
        "folder",
