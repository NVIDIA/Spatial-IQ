...
"""
MCQ inference script for NVIDIA Inference API (Claude Opus 4.6 via Bedrock).
...
def main():
    parser = argparse.ArgumentParser(
        description="Run Claude Opus 4.6 via NVIDIA Inference API (MCQ: send reference + choice images, get A-E answer)."
    )
    parser.add_argument(
        "folder",
