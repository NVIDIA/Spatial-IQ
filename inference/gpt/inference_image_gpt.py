...
Requires a folder path: run SpatialIQ benchmark (image out) on that sample folder or discover all samples under it. Saves task1_pred_image.png .. task10_pred_image.png and task_main_pred_text.txt per view.
"""
